...
void initDIG() {
  ...
  CHANG(I2S_FIFO_CONF_REG,BIT(12)|BIT(5)|BIT(16)|BIT(20))
  ...
  CHANGOR(SENS_SAR_READ_CTRL_REG,BIT(27)|BIT(28)) //dig force inv
  ...
  CHANG(APB_SARADC_FSM_REG,0xFF056408)
